...
export default function SignInButton({
  ...
  const defaultClassName = `
    ...
    dark:bg-[var(--color-app-background)] dark:hover:bg-amber-400
  ...
  // Use custom className OR default styles (no combination)
...
export function GoogleSignInButton(props: Omit<SignInButtonProps, 'provider'>) {
  ...
  const combinedClassName = props.className || googleStyles
...
export function GitHubSignInButton(props: Omit<SignInButtonProps, 'provider'>) {
  ...
  const combinedClassName = props.className || githubStyles
...
export function EmailSignInButton(props: Omit<SignInButtonProps, 'provider' | 'email'> & { email: string }) {
  ...
  const combinedClassName = props.className || emailStyles
