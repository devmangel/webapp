...
export default function SignupClient({ callbackUrl = "/dashboard" }: SignupClientProps) {
    ...
    <div className="space-y-6 max-w-sm mx-auto">
      ...
      <div className="text-xs text-center text-[var(--color-text-secondary)] space-y-2">
        <p>
          ...
          y{' '}
          <Link href="/privacidad" className="text-primary hover:text-secondary underline">
